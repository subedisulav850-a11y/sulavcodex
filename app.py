...
# ================= Protobuf imports (optional – catch errors) =================
duo_pb2 = None
my_pb2 = None
output_pb2 = None
...
# Gallery Items Configuration (default)
ITEMS = {
    "item1": 212000000,
    "item2": 203000000,
    "item3": 212000000,
...
# ===== Updated Duo Endpoint (fully working, with fallback) =====
@app.get("/duo")
async def get_duo(
    ...
    if duo_pb2 is None:
        # Return dummy data if protobuf is not available
