...
async def fetch_real_player_data(uid: str) -> Dict[str, Any]:
    ...
    # ================= FIXED: ROBUST PRIME LEVEL EXTRACTION =================
    prime_level = None
    ...
    # If still None, search recursively for any key containing 'prime' and value int
...
# ===== New /sulav?help endpoint =====
@app.get("/sulav")
async def sulav_help(help: Optional[str] = Query(None)):
    """
    If 'help' parameter is present, returns full list of endpoints with examples.
    """
    ...
    endpoints = {
        ...
        "/banner": {"method": "GET", "params": {"uid": "Player UID", "badge": "Optional badge name", "frame": "Optional frame name"}, "example": f"{base_url}/banner?uid=3074306062&badge=probadge&frame=ebadgeframe"},
...
async def generate_image_endpoint(
    ...
    try:
        ...
        # Fallback: return a simple placeholder image (500x500 gray)
